...
def inference(
    ...
    #LATER: start new thread to run inference 
...
test_ds.targets= test_ds.targets.to(device)
#need to use other datasets to actually test data transfer 
...
def benchmark_with_profiler(
    ...
    with torch.profiler.profile(
        ...
        for step_idx in range(1, num_steps + 1):
            ...
            output = model(test_ds[0][0].unsqueeze(0))
